...
\[Pastor\] The Lord Jesus on the night when he was betrayed took bread,
...
[^9]: The liturgy of the word ends with a song of response to God’s
    Word, ideally suited to the central themes of the sermon. It is a
    way both of giving thanks and further inculcating God’s word through
    song. This particular song highlights Christ’s supremacy over all
    things and our future hope.

[^10]: Having given to the ministries of the church, the congregation
    now intercedes on behalf of their own members, various ministries,
    and their neighbors. It may be helpful to print a list of prayer
    requests in the bulletin for worshipper to follow along with and
    take home for reference throughout the week.

[^11]: The Lord’s Prayer is included every week as an aid to memory and
    as a template for corporate and individual prayer in general. It
    includes even those elements of prayer which may not have been
    featured elsewhere in the intercessory prayer. It also invites the
    people to join their voice in prayer.
...
[^12]: Like Calvin, I have chosen not to call this an offertory, in
    ...
    prayer in order to emphasize the priority of God’s action and
    blessing in the ministries of the church
...
[^15]: The words of institution provide both the remembrance and the
    ...
    consecrate, but are placed first in order to emphasize the priority
...
[^17]: Before partaking of the elements and communing with their Lord,
    worshippers are invited to express their communion with one another
    by passing the peace in a culturally appropriate manner.

[^18]: The congregation is invited to thank God for this means of grace
    the fellowship they have with Christ and one another through song.
    The themes of such songs may include the anticipation of Christ’s
    return, the communion of the saints, or the resurrection. This
    particular hymn was chosen to reflect the communion of the saints,
    with the third stanza reflecting some themes from the sermon.

[^19]: As the last element in the liturgy, the benediction should remind
    the congregation of the blessing they have from God as they go about
